...
#define _AXIS_STEP_PER_UNIT {80, 80 , 4031.496, 595 }
#else
...
const bool X_ENDSTOP_INVERT = true;		// normally open ie 0V equals triggered
const bool Y_ENDSTOP_INVERT = true;		//normally open
const bool Z_ENDSTOP_INVERT = false;	// normally closed ie 5v equals triggered
